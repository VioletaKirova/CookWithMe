namespace CookWithMe.Services.Data.Tests
{
    ...
    public class UserFavoriteRecipeServiceTests
    {
        ...
        {
            var errorMessagePrefix = "UserFavoriteRecipeService GetRecipeIdsByUserIdAsync() method does not work properly.";
            ...
            // Act
            var actualResult = (await userFavoriteRecipeService
